...
url = "https://auth.geeksforgeeks.org/user/gantavenkatakousik2021"
...
institute_rank = user.find(class_='profile_details_section activity-container-1 section_card').find(class_='profile_rank_div tooltipped').find(class_='rankNum').text.strip()
